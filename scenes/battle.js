function setBattle(worldState) {
    document.getElementById('sound').src = `asset/battlesound.mp3`
    add([
    ...
    onUpdate(() => {
        ...
        if (enemyMonHealthBar.width < 0 && !enemyMon.fainted) {
            document.getElementById('sound').src = `asset/winning.mp3`
            ...
            setTimeout(() => {
                ...
                content.text = `MUSHROOM won the battle! you got ${exp} `
                experience += exp
            ...
            setTimeout(() => {
                ...
                go('world', worldState)
                document.getElementById('sound').src = `asset/backsound.mp3`
            }, 10000)
        }
